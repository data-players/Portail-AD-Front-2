...
Le Portail de l'Alimentation Durable est un projet numérique collectif, dont le portage, assuré dans sa première phase par Crisalim et Maurésiaterre, a été confié, en 2025, à AFTERRES. Le projet a déjà permis de rassembler près d'une dizaine d'acteurs qui contribuent à la construction du projet et centraliser les ressources de 6 structures.
    ...
    <div className="agent-page">
      <div className="agent-page-content">
        ...
        <p className="agent-description">
          Votre assistant intelligent pour explorer et exploiter les ressources
          du portail
        </p>
